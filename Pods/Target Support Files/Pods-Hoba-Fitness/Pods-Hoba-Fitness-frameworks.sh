...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/PASImageView/PASImageView.framework"
  ...
  install_framework "${PODS_ROOT}/YandexMobileMetricaPush/dynamic/YandexMobileMetricaPush.framework"
  ...
  install_framework "${PODS_XCFRAMEWORKS_BUILD_DIR}/FunctionalSwift/FunctionalSwift.framework"
  install_framework "${PODS_XCFRAMEWORKS_BUILD_DIR}/MoneyAuth/MoneyAuth.framework"
  install_framework "${PODS_XCFRAMEWORKS_BUILD_DIR}/TMXProfiling/TMXProfiling.framework"
  install_framework "${PODS_XCFRAMEWORKS_BUILD_DIR}/TMXProfilingConnections/TMXProfilingConnections.framework"
  install_framework "${PODS_XCFRAMEWORKS_BUILD_DIR}/ThreatMetrixAdapter/ThreatMetrixAdapter.framework"
  install_framework "${PODS_XCFRAMEWORKS_BUILD_DIR}/YooMoneyCoreApi/YooMoneyCoreApi.framework"
fi
